...
public abstract class AbstractMeasurementRepository<T extends TimestampedMeasurement> {
    ...
    public void save(T  measurement) throws SQLException {
        try (Connection c = ds.getConnection(); PreparedStatement stmt = c.prepareStatement(queries.get("add"))) {
            ...
            stmt.setInt(3, measurement.getDeviceId().getValue());
    ...
    public int delete(final UUID batchId) throws SQLException {
